...
// No props are being passed to this component, so it's a stateless functional component
          ...
          <div className="hero-content flex flex-col gap-y-4">
            ...
            <div className="flex justify-between items-center mt-6 text-white font-bold">
              <div className="text-center">
                ...
                <div className="text-gray-400 font-medium text-lg mt-1">Brands</div>
              </div>
              ...
              <div className="text-center">
                ...
                >
                  <CountUp end={20} duration={2.5} suffix="k+" />
                </div>
                <div className="text-gray-400 font-medium text-lg mt-1">Fashion Designer</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-gray-400 font-medium text-lg mt-1">Fashion Shows</div>
              </div>
            </div>
          </div>
