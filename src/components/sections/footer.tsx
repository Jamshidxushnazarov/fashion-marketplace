...
// Defining a functional component for the Footer in TypeScript
    ...
    <div>
      <div className='container'>
        <div className='container mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 py-12'>
          ...
          {/* Logo Section */}
          <div>
            <h1 className='text-lg font-bold text-purple-400'>LOGO</h1>
          ...
          <div className='text-white'>
            ...
            <p className='text-sm text-gray-300 mb-4'>adorableprogrammer@gmail.com</p>
