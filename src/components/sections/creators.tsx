...
import { card } from "../../utils/creatorsData"; // card - data array
...
const Creators: React.FC = () => {
    const [cards, setCards] = useState<CreatorCardProps[]>(card.map((item) => ({ ...item, id: item.id.toString() })));

    const handleFollowToggle = (id: string) => {
        const updatedCards = cards.map((item: CreatorCardProps) =>
